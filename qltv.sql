USE [master]
GO
/****** Object:  Database [QLTHUVIEN]    Script Date: 20/06/2021 23:25:21 ******/
...
USE [QLTHUVIEN]
GO
/****** Object:  Table [dbo].[KHOA]    Script Date: 20/06/2021 23:25:22 ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[LOP]    Script Date: 20/06/2021 23:25:22 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[MUONTRA]    Script Date: 20/06/2021 23:25:22 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[NGUOIDUNG]    Script Date: 20/06/2021 23:25:22 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[NHAXUATBAN]    Script Date: 20/06/2021 23:25:22 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[QUYDINH]    Script Date: 20/06/2021 23:25:22 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[SACH]    Script Date: 20/06/2021 23:25:22 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[TACGIA]    Script Date: 20/06/2021 23:25:22 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[THELOAI]    Script Date: 20/06/2021 23:25:22 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[VAITRO]    Script Date: 20/06/2021 23:25:22 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[XULYVIPHAM]    Script Date: 20/06/2021 23:25:22 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
INSERT [dbo].[KHOA] ([MAKHOA], [TENKHOA]) VALUES (N'ĐPT', N'Đa phương tiện')
GO
...
GO
INSERT [dbo].[LOP] ([MALOP], [TENLOP], [MAKHOA]) VALUES (N'D19CQCN03', N'Công nghệ thông tin 3', N'CNTT')
GO
...
GO
INSERT [dbo].[MUONTRA] ([MANGUOIDUNG], [MASACH], [NGAYMUON], [HANTRA]) VALUES (N'D06', N'S7', CAST(N'2021-06-20' AS Date), CAST(N'2021-07-13' AS Date))
GO
INSERT [dbo].[MUONTRA] ([MANGUOIDUNG], [MASACH], [NGAYMUON], [HANTRA]) VALUES (N'D06', N'S8', CAST(N'2021-06-20' AS Date), CAST(N'2021-07-08' AS Date))
GO
...
GO
INSERT [dbo].[QUYDINH] ([MAQUYDINH], [SOSACHMUONTOIDA], [SONGAYMUONTOIDA], [TIENPHATQUAHAN], [TIENPHATHONGMAT], [NGAYTHAYDOI]) VALUES (1, 5, 30, 2000, 1.5, CAST(N'2021-06-15' AS Date))
GO
INSERT [dbo].[QUYDINH] ([MAQUYDINH], [SOSACHMUONTOIDA], [SONGAYMUONTOIDA], [TIENPHATQUAHAN], [TIENPHATHONGMAT], [NGAYTHAYDOI]) VALUES (2, 5, 30, 5000, 2, CAST(N'2021-06-15' AS Date))
GO
INSERT [dbo].[QUYDINH] ([MAQUYDINH], [SOSACHMUONTOIDA], [SONGAYMUONTOIDA], [TIENPHATQUAHAN], [TIENPHATHONGMAT], [NGAYTHAYDOI]) VALUES (3, 5, 30, 5000, 3, CAST(N'2021-06-15' AS Date))
GO
INSERT [dbo].[QUYDINH] ([MAQUYDINH], [SOSACHMUONTOIDA], [SONGAYMUONTOIDA], [TIENPHATQUAHAN], [TIENPHATHONGMAT], [NGAYTHAYDOI]) VALUES (4, 5, 30, 3000, 2, CAST(N'2021-06-15' AS Date))
GO
INSERT [dbo].[QUYDINH] ([MAQUYDINH], [SOSACHMUONTOIDA], [SONGAYMUONTOIDA], [TIENPHATQUAHAN], [TIENPHATHONGMAT], [NGAYTHAYDOI]) VALUES (5, 5, 30, 4000, 2, CAST(N'2021-06-15' AS Date))
GO
INSERT [dbo].[QUYDINH] ([MAQUYDINH], [SOSACHMUONTOIDA], [SONGAYMUONTOIDA], [TIENPHATQUAHAN], [TIENPHATHONGMAT], [NGAYTHAYDOI]) VALUES (6, 3, 30, 4000, 1.5, CAST(N'2021-06-15' AS Date))
GO
INSERT [dbo].[QUYDINH] ([MAQUYDINH], [SOSACHMUONTOIDA], [SONGAYMUONTOIDA], [TIENPHATQUAHAN], [TIENPHATHONGMAT], [NGAYTHAYDOI]) VALUES (7, 3, 20, 3000, 1, CAST(N'2021-06-20' AS Date))
GO
INSERT [dbo].[QUYDINH] ([MAQUYDINH], [SOSACHMUONTOIDA], [SONGAYMUONTOIDA], [TIENPHATQUAHAN], [TIENPHATHONGMAT], [NGAYTHAYDOI]) VALUES (8, 3, 20, 3000, 1, CAST(N'2021-06-20' AS Date))
GO
INSERT [dbo].[QUYDINH] ([MAQUYDINH], [SOSACHMUONTOIDA], [SONGAYMUONTOIDA], [TIENPHATQUAHAN], [TIENPHATHONGMAT], [NGAYTHAYDOI]) VALUES (9, 3, 20, 3000, 2, CAST(N'2021-06-20' AS Date))
GO
INSERT [dbo].[QUYDINH] ([MAQUYDINH], [SOSACHMUONTOIDA], [SONGAYMUONTOIDA], [TIENPHATQUAHAN], [TIENPHATHONGMAT], [NGAYTHAYDOI]) VALUES (10, 3, 20, 3000, 2, CAST(N'2021-06-20' AS Date))
GO
INSERT [dbo].[QUYDINH] ([MAQUYDINH], [SOSACHMUONTOIDA], [SONGAYMUONTOIDA], [TIENPHATQUAHAN], [TIENPHATHONGMAT], [NGAYTHAYDOI]) VALUES (11, 3, 20, 3000, 2.0999999046325684, CAST(N'2021-06-20' AS Date))
GO
INSERT [dbo].[QUYDINH] ([MAQUYDINH], [SOSACHMUONTOIDA], [SONGAYMUONTOIDA], [TIENPHATQUAHAN], [TIENPHATHONGMAT], [NGAYTHAYDOI]) VALUES (12, 10, 15, 3500, 2.5, CAST(N'2021-06-20' AS Date))
GO
INSERT [dbo].[SACH] ([MASACH], [TENSACH], [NGAYNHAP], [GIA], [VITRI], [MATACGIA], [MANXB], [MATHELOAI], [SOLUONGCO], [SOLUONGCON]) VALUES (N'S1', N'Mononoke Princess', CAST(N'2021-03-05' AS Date), 50000, N'I don''t know', N'TG01', N'NXB1', N'TL01', 25, 24)
GO
...
GO
INSERT [dbo].[SACH] ([MASACH], [TENSACH], [NGAYNHAP], [GIA], [VITRI], [MATACGIA], [MANXB], [MATHELOAI], [SOLUONGCO], [SOLUONGCON]) VALUES (N'S7', N'Stephen Hawking: Một trí tuệ không giới hạn', CAST(N'2021-03-05' AS Date), 189000, N'I don''t know', N'TG05', N'NXB6', N'TL04', 10, 9)
GO
INSERT [dbo].[SACH] ([MASACH], [TENSACH], [NGAYNHAP], [GIA], [VITRI], [MATACGIA], [MANXB], [MATHELOAI], [SOLUONGCO], [SOLUONGCON]) VALUES (N'S8', N'Hacker lược sử', CAST(N'2021-03-05' AS Date), 299000, N'I don''t know', N'TG06', N'NXB7', N'TL04', 10, 9)
GO
...
GO
INSERT [dbo].[XULYVIPHAM] ([MANGUOIDUNG], [PHATQUAHAN], [PHATHONGMAT], [SOLANVIPHAM]) VALUES (N'D02', 306000, 50000, 3)
GO
INSERT [dbo].[XULYVIPHAM] ([MANGUOIDUNG], [PHATQUAHAN], [PHATHONGMAT], [SOLANVIPHAM]) VALUES (N'D04', 64000, 0, 1)
GO
